...
router.post('/', async (req, res) => {
  ...
  let transporter = nodemailer.createTransport({
    ...
    auth: {
      user: 'fullyalivenz2020@gmail.com', // generated ethereal user
  ...
  let info = await transporter.sendMail({
    from: '"FULLY ALIVE | SFC NATCON" <fullyalivenz2020@gmail.com>', // sender address
    to: 'fullyalivenz2020@gmail.com', // list of receivers
